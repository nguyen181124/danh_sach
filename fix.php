    ...
    <form class="table" action="" method="post">
      <div class="mt-12 ">
        <div class="flex flex-col">
          Họ và tên <input class="input_infor border-2 border-black" type="text" name="name" value='<?php ?>'>
          ...
          Năm sinh <input class="input_infor border-2 border-black" type="text" name="birth" value='<?php ?>'>
          <span class="error text-red-600 block">
            <?php echo $ebirth; ?>
          </span>
          Điểm <input class="input_infor border-2 border-black" type="text" name="score" value='<?php ?>'>
          <span class="error text-red-600 block">
            <?php echo $escore; ?>
          </span>
        </div>
